...
try:
    ...
    chf_buy_course_label_str = "Buy:  PLN"
    chf_sell_course_label_str = "Sell: " + "PLN"

chf_label = tk.Label(window, text="CHF: ", font=12, pady=5, padx=5)
chf_buy_label = tk.Label(window, text=chf_buy_course_label_str, font=12, padx=5)
chf_sell_label = tk.Label(window, text=chf_sell_course_label_str, font=12, padx=5)
...
try:
    ...
    usd_buy_course_label_str = "Buy:  PLN"
    usd_sell_course_label_str = "Sell:  PLN"

usd_label = tk.Label(window, text="USD:", font=16, pady=5, padx=5)
usd_buy_label = tk.Label(window, text=usd_buy_course_label_str, font=12, padx=5)
usd_sell_label = tk.Label(window, text=usd_sell_course_label_str, font=12, padx=5)
...
try:
    ...
    euro_buy_course_label_str = "Buy: PLN"
    euro_sell_course_label_str = "Sell: PLN"

euro_label = tk.Label(window, text="EUR: ", font=16, pady=5, padx=10)
euro_buy_label = tk.Label(window, text=euro_buy_course_label_str, font=12, padx=5)
euro_sell_label = tk.Label(window, text=euro_sell_course_label_str, font=12, padx=5)
...
try:
    ...
    gbp_buy_course_label_str = "Buy: PLN"
    gbp_sell_course_label_str = "Sell: PLN"

gbp_label = tk.Label(window, text="GBP: ", font=16, pady=5, padx=10)
gbp_buy_label = tk.Label(window, text=gbp_buy_course_label_str, font=12, padx=5)
gbp_sell_label = tk.Label(window, text=gbp_sell_course_label_str, font=12, padx=5)
